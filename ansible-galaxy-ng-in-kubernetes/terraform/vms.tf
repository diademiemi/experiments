...
ansible-playbook -b -e "ansible_password=${var.local_password}" qemu.yml -e disk_size=5 -e vyos_version=1.5.0 -e cloud_init=true -e cloud_init_ds=NoCloud -e "vyos_iso_url=https://github.com/vyos/vyos-rolling-nightly-builds/releases/download/1.5-rolling-202309250022/vyos-1.5-rolling-202309250022-amd64.iso" -b
